...
public class Volume {
  ...
  // Retorna o Uso do volume em porcentagem
    public double getUsoAtual() {
    long total = this.volume.getTotalSpace();
    long disponivel = this.volume.getFreeSpace();
    double uso = (double) (total - disponivel) / total * 100;
    return uso;
    }
