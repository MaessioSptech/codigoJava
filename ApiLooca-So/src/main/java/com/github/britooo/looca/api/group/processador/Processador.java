...
public class Processador {
  ...
  public void avisoCpu(String idTotem, String login){
      json.put("text", "O uso da cpu do totem " + idTotem + " ultrapassou o ponto de crítico definido.\n" +
    ...
    "\nAtenciosamente, Infinity Solutions");
      ...
      json2.put("text", "O uso da cpu do totem " + idTotem + " ultrapassou o ponto de atenção definido.\n" +
